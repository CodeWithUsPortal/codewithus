                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="2" class="border-top-0">Content</th>
                                    <th colspan="2" class="border-top-0">Created by</th>
                                    <th colspan="1" class="border-top-0">TimeStamp</th>
                            ...
                            <tbody>
                              @foreach($updates as $update)
                                <tr>
                                    <!-- <td> {{$update['id'] }}</td> -->
                                    <td colspan="2">{{$update['content'] }}</td>
                                    <td colspan="2">{{$update['created_by'] }}</td>
                                    <td colspan="1"> {{$update['created_at']}}</td>
                                </tr>
                              @endforeach
                            </tbody>
                        </table>
